...
def setup(env, num_employees, support_time, customer_interval, break_time):
    global customers_handled
    global employees_needed
    supermarket = Supermarket(env, num_employees, support_time, break_time)
    customers_handled = 0
...
for num_employees in range(1, NUM_CUSTOMERS + 1):
    ...
    env.process(setup(env, num_employees, AVG_SUPPORT_TIME, CUSTOMER_INTERVAL, break_time=0.5))
